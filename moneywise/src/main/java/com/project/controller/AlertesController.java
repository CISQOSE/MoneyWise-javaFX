...
public class AlertesController implements Initializable {
    ...
    @FXML
    private Button btnSeuil100;
    @FXML
    private Label countAlertes;
    @FXML
    private VBox alertesContainer;
    @FXML
    private VBox noAlerteContainer;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if (sidebarController != null)
            sidebarController.setActiveItem("alertes");
    ...
    private void filterTous() {
        updateFilterBtns(btnTous);
        afficherAlertes(toutesLesAlertes);
    }

    // @FXML
    // private void filterNonLues() {
